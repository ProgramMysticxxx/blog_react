            ...
            <ul className="menu navbar__menu">
                ...
                <li className="li_sub-menu">
                    ...
                    <ul className="sub-menu">
                        <li>
                            <Link href="/" className="menu__link sub-menu__link">Development</Link>
                        </li>
                        <li>
                            <Link href="/" className="menu__link sub-menu__link">Administration</Link>
                        </li>
                        <li>
                            <Link to="/" className="menu__link sub-menu__link">Design</Link>
                        </li>
                        <li>
                            <Link to="/" className="menu__link sub-menu__link">Management</Link>
                        </li>
                        <li>
                            <Link to="/" className="menu__link sub-menu__link">Marketing</Link>
                        </li>
                        <li>
                            <Link to="/" className="menu__link sub-menu__link">Popular Science</Link>
                        </li>
                    </ul>
                </li>
                <li>
